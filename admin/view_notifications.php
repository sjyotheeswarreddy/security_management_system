                        ...
                        <div class="header_notification_warp d-flex align-items-center">
                            <li>
                                  <a class="bell_notification_clicker" href="#"> <img src="img/icon/bell.svg" alt="">
                                          ...
                                          <i class='fas fa-user-tie' style='font-size:30px'></i>                                                            <div class="profile_info_iner">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                ...
                                                                <a href="delete_notification.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"> <i class="fas fa-trash" onclick="one()"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
