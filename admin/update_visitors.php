...
if(count($_POST)>0) {
$q2=mysqli_query($con,"UPDATE visitor set  name='" . $_POST['name'] . "', company='" . $_POST['company'] . "', email='" . $_POST['email'] . "', mobile='" . $_POST['mobile'] . "', purpose='" . $_POST['purpose'] . "' WHERE id='" . $_GET['updateid'] . "'");

            if($q2){
                       echo '<script type="text/javascript">';
                       echo 'alert("Data Updated Successfully");';
                        echo "window.location.href='view_visitors.php';";
                         echo '</script>';
      }
      else{
                echo '<script type="text/javascript">';
                echo 'alert("Filed To Insert");';
                echo "window.location.href='update_visitors.php';";
                 echo '</script>';
         }
   }
