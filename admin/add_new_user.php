...
if (isset($_POST['submit'])) {
    ...
    $q1 = mysqli_query($con, "INSERT INTO users(name,email,mobileno,password,company,role,status) VALUES ('$name','$mail','$mob','$pass','$company','$role','$status')");
                                                        ...
                                                        <div class="create_report_btn mt_30">
                                                            <center>
                                                                <input type="submit" style="background-color: #884ffb;border: 1px solid #884ffb;
                                                                    color: #fff;" class="btn_1 radius_btn d-block text-center" name="submit" value="Add User" onclick="one()">
                                                            </center>
