                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=read_view_complaints.php?id=". $row['id']." class='status_btn'>Solved</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=unread_view_complaints.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>unsolved</a>";
                                                                                            ?></a></td>
                                                        </td>
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                <a href="update_complaint.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                                <a href="delete_complaint.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"> <i class="fas fa-trash" onclick="one()"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
