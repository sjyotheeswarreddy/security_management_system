...
if (isset($_POST['submit'])) {
    ...
    $image = $_POST['image'];
  // $status=1;
     $q1 = "INSERT INTO notifications2(subjectofNotification,MessageofNotifications,image) VALUES ('$subjectofNotification','$MessageofNotifications','$image')";
                                                        ...
                                                        <div class="create_report_btn mt_30">
                                                            <center>
                                                                <input type="submit" style="background-color: #884ffb;border: 1px solid #884ffb;
                                                                    color: #fff;" class="btn_1 radius_btn d-block text-center" name="submit" value="SUBMIT" onclick="one()">
                                                            </center>
