...
$q2=mysqli_query($con,$q1);
         if(!$q2){
                    ...
                    echo 'alert("Notification Updated Successfully");';
                     echo "window.location.href='view_notifications.php';";
                      echo '</script>';
   }
   else{
             echo '<script type="text/javascript">';
             echo 'alert("Filed To Insert");';
             echo "window.location.href='update_notifications.php';";
              echo '</script>';
      }
}
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="modal-content cs_modal">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="subjectofNotification" placeholder="subject Notification" value="<?php echo $subjectofNotification; ?>"/>
                                    </div>
                                        <div class="white_card card_height_100 mb_30">
                                            <div class="white_card_body">
                                                <div class="row">
                                                    ...
                                                    <form action="" method="POST">
                                                    <input type="text" name="MessageofNotifications" placeholder="Message Notification" value="<?php echo $MessageofNotifications; ?>"/>
                                                    </div>
                                                    <div class="col-lg-12">
