...
// while ($total = mysqli_fetch_array($sum)) {
//     $total_amt = $total['COUNT(id)'];
// }
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                                                            if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=deactivate_users.php?id=". $row['id']." class='status_btn'>Activate</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=activate_users.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>Deactivate</a>";
                                                                                            ?></a></td>
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                <a href="update_users.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                                <a href="delete_users.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"> <i class="fas fa-trash" onclick="one()"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
