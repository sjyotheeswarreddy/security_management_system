...
$id1=$_GET['rentalsid'];
if (count($_POST) > 0) {
    $q1=mysqli_query($con, "UPDATE rent set  SelectCompanys='" . $_POST['SelectCompanys'] . "', RentAmount='" . $_POST['RentAmount'] . "', Rentaldate='" . $_POST['Rentaldate'] . "' WHERE id='" . $_GET['rentalsid'] . "'");
  if($q1){
        ...
        echo '<script type="text/javascript">';
           ...
           echo "window.location.href='add_rent.php';";
           echo '</script>';
    }
}
$result1 = mysqli_query($con, "SELECT * FROM rent WHERE id='" . $_GET['rentalsid'] . "'");
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="modal-content cs_modal">
                                <div class="modal-header theme_bg_1 justify-content-center">
                                    <h5 class="modal-title text_white">Edit Rentals</h5>
                                </div>
