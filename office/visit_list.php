                    ...
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            ...
                            <ol class="breadcrumb page_bradcam mb-0">
                                ...
                                <li class="breadcrumb-item active">View Visitors list</li>
                            </ol>
                        </div>
                                ...
                                <div class="QA_table mb_30">
                                        ...
                                        <table class="table lms_table_active ">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 0;
                                                $result = mysqli_query($con, "SELECT * FROM visitor WHERE company='$company1'");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            ...
                                                            elseif($row['status']=="0")
                                                                ...
                                                                echo
                                                                "<a href=Reject_visiter.php?id=" . $row['id'] . " class='status_btn' style='background-color: blue;'>add</a>";
                                                            ?></a></td>
                                                       <td>
                                                       
                                                            <div class="action_btns d-flex">
                                                                <a href="edit.php?id=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                               <a href="javascript:void(0)" onclick="delRecord(<?php echo $row['id']; ?>)"class="action_btn"> 
