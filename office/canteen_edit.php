...
$id1=$_GET['updateid'];
if(count($_POST)>0) {
$q1=mysqli_query($con,"UPDATE canteen set itemname='" . $_POST['itemname'] . "', price='" . $_POST['price'] . "', image='" . $_POST['image'] . "' WHERE id='" . $_GET['updateid'] . "'");
if($q1){
        echo '<script type="text/javascript">';
           echo 'alert("Data Updated Successfully");';
           echo "window.location.href='canteen_view.php';";
           echo '</script>';
    }else{
        echo '<script type="text/javascript">';
           echo 'alert("Failed to update");';
           echo "window.location.href='canteen_add.php';";
           echo '</script>';
    }
}
$result1= mysqli_query($con,"SELECT * FROM canteen WHERE id='" . $_GET['updateid'] . "'");
                    ...
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            ...
                            <ol class="breadcrumb page_bradcam mb-0">
                                ...
                                <li class="breadcrumb-item active">Edit Canteen</li>
                            </ol>
                        </div>
