...
$result = mysqli_query($con, "SELECT * FROM users WHERE company='$company'");
                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30">Manager dashboard</h3>
            ...
            <div class="row ">
                ...
                <div class="col-xl-6">
                    <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-4">
                                    <div class="main-title">
                                        <h3 class="m-0">Complaintslist</h3>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                        ...
                        error_reporting(E_ERROR | E_PARSE);
                        require_once("config.php");
                        $result = mysqli_query($con, "SELECT * FROM complaints where complaint_Type='manager' limit 5");
                        if (isset($_GET[''])) {
                            echo $_GET['msg'];
                        }
                        include_once('./index.php');
                ...
                <div class="col-xl-6">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        error_reporting(E_ERROR | E_PARSE);
                        require_once("config.php");
                        $result = mysqli_query($con, "SELECT * FROM notifications2 limit 7");
                        if (isset($_GET[''])) {
                            echo $_GET['msg'];
                        }
                        include_once('./index.php');
