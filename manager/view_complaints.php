                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=read_view_complaints.php?id=". $row['id']." class='status_btn'>Read</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=unread_view_complaints.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>Unread</a>";
                                                                                            ?></a></td>
