                                            ...
                                            <div class="notify_content">
                                                <a href="view_notification2.php">
                                                     <h5><?php echo $row["MessageofNotifications"]; ?></h5>
                                                        ...
                                                        <p><?php echo $row["subjectofNotification"]; ?></p></a>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>
                                                            ...
                                                            <div class="action_btns d-flex">
                                                               ...
                                                               <a href="delete.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"onclick="val()"> <i class="fas fa-trash"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
...
<script>
function val(){
alert("delete visitor sucessfully!!");
}
</script>
