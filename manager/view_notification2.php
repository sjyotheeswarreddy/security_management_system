...
<?php
                                        ...
                                        <div class="single_notify d-flex align-items-center">
                                            <div class="notify_thumb">
                                                <a href="view_notification2"><img src="img/customers/1.png" alt=""></a>
                                            </div>
                                            <div class="notify_content">
                                                <a href="view_notification2">
                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30">view
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["image"]; ?></td>
                                                          <td><?php
                                                                                            if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=unread_view_notification.php?id=". $row['id']." class='status_btn'>read</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=read_view_notification.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>Unread</a>";
                                                                                            ?></a></td>
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                <a href="update_not_ifications.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                                <script>
                                                                function val() {
                                                                alert("deleted successfully")
                                                                }</script>
                                                                <a href="delete_notification.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn" onclick="val()"> <i class="fas fa-trash"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
