...
$q2=mysqli_query($con,$q1);
            if(!$q2){
                       ...
                       echo 'alert("Visitor Updated Successfully");';
                                                        ...
                                                        <select class="nice_Select2 nice_Select_line wide" name="company" value="<?php echo $row['company']; ?>" style="display: none;">
                                                            <option value="">Select company name</option>
                                                             <option value="Sagar Software Solutions pvt ltd"
                                                                    <?php
                                                                    if($row['company'] == 'Sagar Software Solutions pvt ltd')
                                                                    {
                                                                        echo "selected";
                                                                    }
                                                                    ?>
                                                            ...
                                                            <option value="Conflux systems" 
                                                                    <?php
                                                                    if($row['company'] == 'Conflux systems')
                                                                    {
                                                                        echo "selected";
                                                                    }
                                                                    ?>
                                                            ...
                                                            <option value="Integer Telecom"
                                                                    <?php
                                                                    if($row['company']== 'Integer Telecom')
                                                                    {
                                                                        echo "selected";
                                                                    }
                                                            ...
                                                            <option value="iGen American soft"
                                                                   <?php
                                                                    if($row['company']== 'iGen American soft')
                                                                    {
                                                                        echo "selected";
                                                                    }
                                                            ...
                                                            <option value="Magunti IT solutions"
                                                                    <?php
                                                                    if($row['company']== 'Magunti IT solutions')
                                                                    {
                                                                        echo "selected";
                                                                    }
