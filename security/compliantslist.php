                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30">View Users</h3>
                                        ...
                                        <table class="table lms_table_active ">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">compliants status</th>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                                                            if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=deactivate_user.php?id=". $row['id']." class='status_btn'>Deactivate</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=activate_user.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>Activate</a>";
                                                                                            ?></a></td>
                                                        <td>
