...
$result = mysqli_query($con, "SELECT * FROM notifications2");
                        ...
                        <div class="white_card_body">
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    ?>
                                    <!-- <table class="table table lms_table_active table-responsive dataTable no-footer  " id="fid_table" style="width:890px;" role="grid" aria-describedby="mytable_info"> -->

                                        <table class="table lms_table_active  ">
                                            <thead>
                                                <tr>
                                                    <th scope="col">id</th>
                                                    <th scope="col">subjectofNotification</th>
                                                    <th scope="col">MessageofNotifications</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["subjectofNotification"]; ?></td>
                                                        <td><?php echo $row["MessageofNotifications"]; ?></td>
                                                        <td><?php echo $row["image"]; ?></td>
                                                        <td><?php
                                                           if ($row['status'] == "0")
                                                           echo
                                                           "<a href=unred_view_notification.php?id=" . $row['id'] . " class='status_btn' style='background-color: #f44336;'>unread</a>";
                                                       else
                                                           echo
                                                           "<a href=read_view_notification.php?id=" . $row['id'] . " class='status_btn' >read</a>";
                                                       ?></a></td>
                                                   <td>
                                                            <div class="action_btns d-flex">
                                                                <a href="update_notifications.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                                <a href="delete_notifications.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"> <i class="fas fa-trash" onclick="one()"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
