...
$id1=$_GET['updateid'];
if(count($_POST)>0) {
$q2=mysqli_query($con,"UPDATE notifications2 set  subjectofNotification='" . $_POST['subjectofNotification'] . "', MessageofNotifications='" . $_POST['MessageofNotifications'] . "', image='" . $_POST['image'] . "' WHERE id='" . $_GET['updateid'] . "'");
   
    if($q2){
        echo '<script type="text/javascript">';
           echo 'alert("Data Updated Successfully");';
           echo "window.location.href='view_notification.php';";
           echo '</script>';
    }else{
        echo '<script type="text/javascript">';
