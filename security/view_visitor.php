                                        ...
                                        <table class="table lms_table_active ">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Select Company Name</th>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>
                                                            ...
                                                            <div class="action_btns d-flex">
                                                                <a href="update_visitors.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i></a>
                                                               <a href="delete_visitors.php?deleteid=<?php echo $row['id'];?>"class="action_btn"><i class="fas fa-trash" onclick="delRecord()"></i> </a> 
