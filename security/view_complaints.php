...
$result = mysqli_query($con, "SELECT * FROM complaints WHERE complaint_Type='security' ");
...
<html>
  ...
  #complantsView{ overflow-x:auto !important; overflow-y:auto !important;
}
/* .sorting{display:inline-block !important;
width: auto;
height: auto;
} */
                    ...
                    <div class="serach_field-area d-flex align-items-center">
                        <div class="search_inner">
                            <form action="#">
                                ...
                                <button type="submit" class="ml-3"> <img src="img/icon/icon_search.svg" alt=""> </button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="white_card_body">
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    ?>
                                    <table class="table table-responsive dataTable lms_table_active   " id="complantsView">

                                        <!-- <table class="table lms_table_active " id="complantsView"> -->
                                            <thead>
                                                <tr>
                                                    <th scope="col">id</th>
                                                    <th scope="col">complaint_type</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                       ...
                                                       if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=unread_view_complaints.php?id=". $row['id']." class='status_btn'>read</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=read_view_complaints.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>unread</a>";
                                                                                            ?></a></td>
                                                        </td>
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                <a href="update_complaint.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                               <a href="delete_complaint.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"onclick="val()"> <i class="fas fa-trash"></i> </a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $i++;
