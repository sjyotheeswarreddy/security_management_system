...
if(count($_POST)>0) {
mysqli_query($con,"UPDATE complaints set  complaint_Type='" . $_POST['complaint_Type'] . "', description='" . $_POST['description'] . "', image='" . $_POST['image'] . "' WHERE id='" . $_GET['updateid'] . "'");
$message = "Record Modified Successfully";
header("location:compliantslist.php");
}
$result = mysqli_query($con,"SELECT * FROM complaints WHERE id='" . $_GET['updateid'] . "'");
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="modal-content cs_modal">
                                <div class="modal-header theme_bg_1 justify-content-center">
                                    <h5 class="modal-title text_white">Update complaint</h5>
                                </div>
                                        ...
                                        <div class="white_card card_height_100 mb_30">
                                            ...
                                            <div class="white_card_body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <select class="nice_Select2 nice_Select_line wide" name="complaint_Type" value="<?php echo $row['complaint_Type']; ?>" style="display: none;">

                                                            <option value="">complaint_Type</option>
                                                            <option value="maintainance"
                                                            <?php
                                                                                                                                if($row['complaint_Type'] == 'maintainance')
                                                                                                                                {
                                                                                                                                    echo "selected";
                                                                                                                                }
                                                                                                                                ?>
                                                            ...
                                                            <?php
                                                                                                                                if($row['complaint_Type'] == 'security')
                                                                                                                                {
                                                                                                                                    echo "selected";
                                                                                                                                }
                                                                                                                                ?>
