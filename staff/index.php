...
//echo '<script>alert("Sucellfull login")</script>';
?>
<?php
                    require 'config.php';
session_start();
                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30">Staff dashboard</h3>
            ...
            <div class="row ">
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM complaints where status=1";
                                        $query_run = mysqli_query($con, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> ' . $row . '</h4>';
                                        ?>
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM canteen ORDER BY id";
                                        $query_run = mysqli_query($con, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> ' . $row . '</h4>';
                                        ?>
                ...
                <div class="col-xl-6">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        error_reporting(E_ERROR | E_PARSE);
                        require_once("config.php");
                        $result = mysqli_query($con, "SELECT * FROM complaints where complaint_Type='staff' limit 5");
                        if (isset($_GET[''])) {
                            echo $_GET['msg'];
                        }
                        include_once('./index.php');
                        ...
                        ?>
                            <div class="single_user_pil d-flex align-items-center justify-content-between">
                                <div class="user_pils_thumb d-flex align-items-center">
                                    ...
                                    <span class="f_s_14 f_w_400 text_color_11"><?php echo $row["complaint_Type"]; ?></span>
                                    </marquee>
                                </div>
                                <div class="user_info">
                                ...
                                <?php
                                    if ($row['status'] == "1")
                                        echo
                                        "<a href=?id=". $row['id']." class='status_btn'>solved</a>";
                                    else
                                        echo
                                        "<a href=?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>unsolved</a>";
                                ?>
                                </div>
                            </div>
                        <?php
                        ...
                        ?>
                            <div class="single_user_pil d-flex align-items-center justify-content-between">
                                <div class="user_pils_thumb d-flex align-items-center">
                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="img/customers/1.png" alt=""></div>
                                    <marquee width="50%" behavior="scroll" direction="left" style="font-size: 12px; font-family: Arial;height:17px;" scrollamount="1">
                                    <span class="f_s_14 f_w_400 text_color_11"><?php echo $row["subjectofNotification"]; ?></span>
                                    </marquee>
                                </div>
                                <div class="user_info">
                                <?php echo $row["MessageofNotifications"]; ?>
                                </div>
                                <div class="action_btns d-flex">
                                <?php
                                    if ($row['status'] == "1")
