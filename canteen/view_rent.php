                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30">Rent Alert</h3>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["SelectCompany"]; ?></td>
                                                        ...
                                                        <td><?php
                                                                                            if ($row['status'] == "1")                
                                                                                                echo
                                                                                                "<a href=deactivate_view.php?id=". $row['id']." class='status_btn'>Paid</a>";
                                                                                            else
                                                                                                echo
                                                                                                "<a href=activate_view.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>Not Paid</a>";
                                                                                            ?></a></td>
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                <a href="update_user.php?updateid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                                <a href="delete_user.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn"> <i class="fas fa-trash"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
