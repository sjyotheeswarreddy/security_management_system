...
if(count($_POST)>0) {
mysqli_query($con,"UPDATE subjectofnotification='" . $_POST['subjectofnotification'] . "', messageofnotification='" . $_POST['messageofnotification'] . "', image='" . $_POST['image'] ."' WHERE id='" . $_GET['updateid'] . "'");
                                                ...
                                                <div class="row">
                                                     <div class="col-lg-12">
                                                        <div class="common_input mb_15">
                                                            <input type="text" name="Subjectofnotification" value="<?php echo $row['Subjectofnotification']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="common_input mb_15">
                                                            <input type="text" name="Messageofnotifications" value="<?php echo $row['Messageofnotifications']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="col-lg-12">
