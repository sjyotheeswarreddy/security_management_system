...
$id1=$_GET['updateid'];
if(count($_POST)>0) {
$q2=mysqli_query($con,"UPDATE canteen set itemname='" . $_POST['itemname'] . "', price='" . $_POST['price'] . "', image='" . $_POST['image'] . "' WHERE id='" . $_GET['updateid'] . "'");
  if($q2){
                ...
                echo "window.location.href='canteen_edit.php';";
                 echo '</script>';
         }
}
