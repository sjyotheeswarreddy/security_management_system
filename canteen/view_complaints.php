...
$result = mysqli_query($con, "SELECT * FROM complaints WHERE complaint_Type='canteen' ");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                ...
                                                                <a href="del_complaint.php?deleteid=<?php echo $row["id"]; ?>" class="action_btn mr_10"> <i class="fas fa-trash" onclick="one()"></i> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
